...
Scenario Outline: Check if a city and and country given are correct
    ...
    When I ask for the city and country name and the response is in json or xml
    Then I check if the city and country are correct and in the correct format
...
Scenario Outline: Check if a latitude and longitude given are correct
    ...
    When I ask for the latitude and longitude and the response is in json or xml
    Then I check if the latitude and longitude are correct and in the correct format
    And I check if the status code is 200
